...
`/path/to/user/Desktop/Open Claw为什么爆火？ (1).mp4`

工作目录：

`/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117`
...
![最终 3:4 竖版](</path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/covers-seedream-text/info-heavy.jpg>)

最终 4:3 横版：

![最终 4:3 横版](</path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/landscape-4x3/landscape.jpg>)
...
![最佳横版审美参考 v4](</path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260518_201532/landscape-4x3-v4/landscape.jpg>)

三张 3:4 候选预览：

![3:4 候选预览](</path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/covers-seedream-text/preview.jpg>)
...
python3 video-cover-generator/scripts/run_cover_workflow.py \
  --video '/path/to/user/Desktop/Open Claw为什么爆火？ (1).mp4' \
  --stop-after gate
```
...
python3 video-cover-generator/scripts/run_cover_workflow.py \
  --video '/path/to/user/Desktop/Open Claw为什么爆火？ (1).mp4' \
  --workdir '/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117' \
...
横版布局参考：/path/to/user/Desktop/OpenClaw封面_4比3 1.png
```
...
```text
/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260518_201532/landscape-4x3-v4/landscape.jpg
```
...
```text
/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260518_201532/consistency.cross-format.v4-preferred.json
```
...
| 类型 | 路径 |
|---|---|
| 工作目录 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117` |
| 视频分析 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/analysis.json` |
| 标题候选 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/titles.json` |
| 真人门控 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/person_asset_gate.json` |
| 3:4 提示词 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/prompts.seedream.text.json` |
| 3:4 review 页 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/review.seedream.text.html` |
| 最终 3:4 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/covers-seedream-text/info-heavy.jpg` |
| 4:3 提示词 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/landscape-4x3/landscape.prompt.json` |
| 最终 4:3 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/landscape-4x3/landscape.jpg` |
| 一致性检查 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/consistency.cross-format.json` |
| 流程报告 | `/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/workflow_report.md` |
...
```text
3:4 竖版：/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/covers-seedream-text/info-heavy.jpg
4:3 横版：/path/to/user/Desktop/video-covers/Open Claw为什么爆火？ (1)_20260519_172117/landscape-4x3/landscape.jpg
```
